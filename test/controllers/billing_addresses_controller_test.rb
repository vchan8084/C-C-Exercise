...
class BillingAddressesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create billing_address" do
    assert_difference('BillingAddress.count') do
      post billing_addresses_url, params: { billing_address: { address: @billing_address.address, city: @billing_address.city, email_address: @billing_address.email_address, name: @billing_address.name, phone_number: @billing_address.phone_number, state: @billing_address.state, zip: @billing_address.zip } }
    end
  ...
  test "should update billing_address" do
    patch billing_address_url(@billing_address), params: { billing_address: { address: @billing_address.address, city: @billing_address.city, email_address: @billing_address.email_address, name: @billing_address.name, phone_number: @billing_address.phone_number, state: @billing_address.state, zip: @billing_address.zip } }
